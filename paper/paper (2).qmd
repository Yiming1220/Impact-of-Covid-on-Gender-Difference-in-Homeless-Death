...
The analysis will be conducted in [@citeR] and will utilize an array of packages such as [@citetidyverse], [@ciitereadr], [@citedplyr], and [@citeopendatatoronto] for data manipulation and analysis. All visualizations in this report are generated through [@citeggplot2], with tables crafted using [@citekableExtra].
