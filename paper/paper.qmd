---
title: "Exacerbated by the Pandemic: Analyzing the Impact of COVID-19 on Mortality Among Toronto's Homeless with a Lens on Gender Disparities"
...
toc: true
toc-depth: 3
thanks: "Code and data are available at . Reproduction record available at "
---
# Introduction
...
The analysis will be conducted in R (R Core Team 2020) and will utilize an array of packages such as tidyverse (Wickham et al. 2019), readr (Wickham, Hester, and Bryan 2024), dplyr (Wickham et al. 2021), and opendatatoronto (Gelfand 2020) for data manipulation and analysis. All visualizations in this report are generated through ggplot2 (Wickham 2016), with tables crafted using kableExtra (Zhu 2021).
...
- $Y_{it}$ is the death count for gender $i$ at time $t$,
